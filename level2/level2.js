...
class Person {
    constructor(x, imageSrc, scoreValue = 1) {
        this.width = 50; 
        this.height = 50; 
        this.positionX = x;
        this.positionY = 100;
...
class Game {
    constructor() {
        ...
        this.backgroundImage.src = "C:/Users/Madhusudhan/Desktop/Game On/Air-Rescue/Assets/Level 2 bg.png";
    }

    spawnPerson() {
        const personX = this.plane.positionX + this.plane.width / 2 - 25;
        const isSpecialPerson = Math.random() < 0.3;
        const imageSrc = isSpecialPerson
            ? "C:/Users/Madhusudhan/Desktop/Game On/Air-Rescue/Assets/man.png"
            : "C:/Users/Madhusudhan/Desktop/Game On/Air-Rescue/Assets/woman.png";
        const scoreValue = isSpecialPerson ? 2 : 1;
    
        this.fallingPeople.push(new Person(personX, imageSrc, scoreValue));
    }
    ...
    updateGame() {
        ...
        this.fallingPeople.forEach((person, index) => {
            ...
            if (person.checkCollision(this.fireman1)) {
                this.fireman1.score += person.scoreValue;
                ...
                this.fireman2.score += person.scoreValue;
